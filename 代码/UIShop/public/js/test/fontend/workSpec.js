...
//        expect(workSearchCtrl.works.length).toEqual(1);
//        expect(workSearchCtrl.pageNum).toEqual(1);
//        expect(workSearchCtrl.searchKw).toEqual(workSearchCtrl.keyword);
        console.log(loc.path())
        expect(loc.path()).toEqual('/searchWorks');

    });

//    it('search work by page',function() {
//        mockBackend.expectGET('/api/work?keyword=%E8%93%9D%E8%89%B2')
//            .respond(200,works);
//        workSearchCtrl.searchWork();
//        mockBackend.flush();
...
//        works.push(work);
//
//        mockBackend.expectGET('/api/work?keyword=%E8%93%9D%E8%89%B2&pageNum=2')
//            .respond(200,works);
//        workSearchCtrl.loadMore();
//        mockBackend.flush();
//
//        expect(workSearchCtrl.works.length).toEqual(3);
//    });
